  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex flex-col justify-between w-[480px] shrink-0 bg-[#0F0D0A] border-r border-[#2C271F] p-12 relative overflow-hidden dot-grid">
        ...
        <div className="absolute bottom-40 right-0 w-48 h-48 rounded-full bg-[#B5704F]/5 blur-3xl pointer-events-none" />
        ...
        <div className="relative z-10 space-y-6">
          ...
          >
            Craft your<br />
            <em className="text-[#C8A882] not-italic">vision.</em>
          </h1>
          <p className="text-[15px] text-[#6B5E50] leading-relaxed">
            AI-powered creative studio for social media automation, content creation, and intelligent agents.
          </p>
          <ul className="space-y-3">
            {[
              "Generate stunning images with FLUX Pro",
              "Automate social media across 7 platforms",
              "Build and deploy AI agents 24/7",
        ...
        <div className="relative z-10 flex items-center gap-3">
          ...
          <span className="font-mono text-[11px] text-[#6B5E50]">Trusted by 1,247 creators</span>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 bg-[#111009]">
        ...
        <p className="font-mono text-[11px] text-[#6B5E50] mb-6 tracking-widest">[ welcome back ]</p>
        <SignIn
          appearance={{
            variables: {
              colorPrimary: "#C8A882",
